...
SRC := src/exit/free_elements.c src/movements/movements.c src/movements/movementsutils2.c \
		...
		src/ray-casting/mlx_utils.c src/ray-casting/player.c src/ray-casting/raycasting.c src/textures/texture.c src/textures/texture_utils.c \
		src/vec2/vec2.c src/vec2/vec2utils.c src/vec3/vec3.c \
